...
const GalleryUploader = ({ packageFormData, setpackageFormData }) => {
    ...
    reader.onloadend = () => {
      ...
      img.onload = () => {
        if (img.width > maxSize || img.height > maxSize) {
          ...
          setError("");
          setpackageFormData((prevState) => ({
            ...prevState,
            package_image: [reader.result],
          }));
        }
      };
      img.onerror = () => {
  ...
  return (
    <div className="row x-gap-20 y-gap-20 pt-15">
      ...
      {packageFormData?.package_image?.length > 0 && (
        <div className="col-auto">
          <div className="d-flex ratio ratio-2:1 w-200">
            <img
              src={packageFormData.package_image[0]}
              alt="Uploaded"
