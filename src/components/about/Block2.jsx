  ...
  const expertContent = [
    {
      ...
      text: `Get discovered by couples actively searching for wedding services in your area.`,
    },
    {
      id: 2,
      icon: "/img/featureIcons/1/2.svg",
      title: "Boost Your Brand",
      text: `Enhance your credibility by being part of a trusted platform.`,
    },
    {
      id: 3,
      icon: "/img/featureIcons/1/3.svg",
      title: "Customer Care 24/7",
      text: `Rely on our dedicated team to help you make the most of your WedEazzy experience.`,
    },
  ];
      ...
      <div className="container">
        <div className="row">
          <div className="col-xl-4 col-md-7">
            <h2 className="text-30 fw-600">Why Partner with WedEazzy</h2>
            <p className="mt-5">
              Join Our Exclusive Network of Wedding Professionals
            </p>
