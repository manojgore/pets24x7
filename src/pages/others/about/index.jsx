...
const metadata = {
  title: "About | WedEazzy - Your Dream Wedding Partner",
    ...
    <>
      ...
      <section className="section-bg layout-pt-lg layout-pb-lg">
        <div className="section-bg__item col-12">
          <img src="/img/pages/about/1.jpg" alt="image" />
        </div>
        ...
        <div className="container">
          <div className="row justify-center text-center">
            <div className="col-xl-6 col-lg-8 col-md-10">
              <h1 className="text-40 md:text-25 fw-600 text-white  font-dancing-script">
                About Us
              </h1>
              <div className="text-white mt-15">
                Passionate About Your Big Day
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="row justify-center text-center">
            <div className="col-auto">
              <div className="sectionTitle -md">
                ...
                <p className=" sectionTitle__text mt-5 sm:mt-0">
                  Planning your wedding is a once-in-a-lifetime experience, and we’re here to make it unforgettable.
                </p>
              </div>
            </div>
          </div>
